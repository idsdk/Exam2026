...
public class Chap05_01Controller {
    ...
    @GetMapping("/chap0504/{id}/user/{id2}")
    public String requestMethod(@MatrixVariable(pathVar = "id") MultiValueMap<String, String> var1, @MatrixVariable(pathVar = "id2") MultiValueMap<String, String> var2, Model model) {
